...
public class Deal {
    public static void main(String[] args) {
        String readFile = "H:/comin_dataset/geolife_slip1.txt";
        String wirteFile = "H:/comin_dataset/geolife_slip2.txt";
    ...
    public static void writeFileOnLine(String readFileName,String writeFileName){
        ...
        try {
            ...
            while ((line = br.readLine()) != null){
                String[] dataStream = line.split("\t");
                if (!" ".contains(line)){
                    SlidePointWindow[1] = new Point(Integer.parseInt(dataStream[0].trim()),Double.parseDouble(dataStream[1].trim()),Double.parseDouble(dataStream[2].trim()),Integer.parseInt(dataStream[3].trim()));
